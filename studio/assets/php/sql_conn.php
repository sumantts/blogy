<?php
	...
	$title = 'GloCal Charcha';
	$logo_text = 'GloCal';

    $p_name = 'GloCal Charcha';
	$logo = 'golocal_logo.png';//'confirm-logo.jpg';//'logo.png';
	$ico = 'golocal_logo.png';//'confirm-logo.jpg';//'favicon.ico';
